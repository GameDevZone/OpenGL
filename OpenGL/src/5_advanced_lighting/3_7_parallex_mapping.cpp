...
int main(void)
{
	...
	Shader quadNormalProgram(
		"shader/5_section_shaders/3_7_parallex_mapping.vs",
		"shader/5_section_shaders/3_7_parallex_mapping.fs");
	...
	unsigned int brickNormalMap = loadTexture("Resources/textures/bricks2_normal.jpg", false);
	...
	quadNormalProgram.SetInt("depthMap", 1);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		quadNormalProgram.SetFloat("height_scale", heightScale);
		...
		glBindTexture(GL_TEXTURE_2D, brickDepthMap);
		renderQuad();
