...
int main(void)
{
	...
	Shader shaderProgram(
		"shader/5_section_shaders/2_1_gamma_correction.vs",
		"shader/5_section_shaders/2_1_gamma_correction.fs");
	...
	shaderProgram.Use();
	shaderProgram.SetInt("floorTexture", 0);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3fv(glGetUniformLocation(shaderProgram.ShaderID, "lightPositions"), 4, &lightPositions[0][0]);
		glUniform3fv(glGetUniformLocation(shaderProgram.ShaderID, "lightColors"), 4, &lightColors[0][0]);
