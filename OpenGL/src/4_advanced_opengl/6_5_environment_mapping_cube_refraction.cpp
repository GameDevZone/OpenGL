...
int main(void)
{
	...
	Shader shaderProgram("shader/4_section_shaders/6_5_environment_mapping_refraction.vs", "shader/4_section_shaders/6_5_environment_mapping_refraction.fs");
