...
int main(void)
{
	...
	Shader shaderProgram("shader/4_section_shaders/6_6_environment_mapping_model_reflection.vs", 
		"shader/4_section_shaders/6_6_environment_mapping_model_reflection.fs");
