...
int main(void)
{
	...
	Shader shaderProgram("shader/2_section_shaders/6_1_lightcaster_multiplelights.vs", "shader/2_section_shaders/6_1_lightcaster_multiplelights.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		if (lightRotate)
		{
			...
			float x = sin(totalDelta) * 15.0f;
			float y = cos(totalDelta) * 15.0f;
