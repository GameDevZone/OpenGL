...
int main(void)
{
	...
	Shader shaderProgram("shader/2_section_shaders/4_4_lightmap_specular_colored.vs", "shader/2_section_shaders/4_4_lightmap_specular_colored.fs");
	...
	unsigned int specularTexture = loadTexture("Resources/textures/lighting_maps_specular_color.png");
